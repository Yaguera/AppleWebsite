...
const VideoCarousel = () => {
    ...
    useEffect(() => {
        ...
        if(span[videoId]){
            // animar a barra de progresso do video]
    ...
    const handleProcess = (type, i) => {
        let currentAnim = videoSpanRef.current[video.videoId];
        if (currentAnim) {
            gsap.killTweensOf(currentAnim);
            gsap.set(currentAnim, { width: 0, backgroundColor: '#afafaf' });
        }
        ...
        switch(type) {
            ...
            case 'set-video':
                setVideo((prevVideo) => ({
                    ...prevVideo, videoId: i, startPlay: true, isPlaying: true
                }))
                break
            default:
                return video;
                ...
                <div key={list.id} id='slider' className='sm:pr-20 pr-10'>
                    <div className='video-carousel_container'>
                        ...
                        <div className='absolute top-12 left-[5%] z-10'>
                            ...
                            {/* quando coloca-se os parenteses já é um retorno automatico */}
                        </div>
                    </div>
                </div>
            ))}
